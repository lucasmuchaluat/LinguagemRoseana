...
class Tokenizer:
    ...
    def montador(origin):
        ...
        isString = 0
        stringText = ""
        palavrasReservadas = ["escancarar", "candonga",
                              "ramerrao", "bispar", "borra", "int", "bool", "string", "true", "false", "batoque"]
        operadoresDuplos = ["=", "&", "|"]
